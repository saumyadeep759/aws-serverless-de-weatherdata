...
QUERY_RESULTS_BUCKET = 's3://sam-athena-query-results-bucket-may-2024/'
MY_DATABASE = 'de_project_database_sam'
SOURCE_PARQUET_TABLE_NAME = 'weather_data_batch_parquet_tbl_sam'
NEW_PROD_PARQUET_TABLE_NAME = 'weather_data_batch_parquet_tbl_sam_prod'
